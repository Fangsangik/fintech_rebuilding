...
public enum ErrorType {
    ...
    TRANSACTION_DELETE_FAILED("거래 삭제에 실패했습니다.", HttpStatus.INTERNAL_SERVER_ERROR),
    TRANSACTION_NOT_FOUND("거래를 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
    NOT_ALLOWED_ACCESS("잘못된 접근입니다.", HttpStatus.NOT_FOUND),
    PASSWORD_INCORRECT("비밀번호가 일치하지 않습니다.", HttpStatus.BAD_REQUEST),
    MEMBER_EXIST("존재하는 회원입니다.", HttpStatus.BAD_GATEWAY),
